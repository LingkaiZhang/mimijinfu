 ...
 * description: (描述)
 * autour: czz
 * date: 2017/5/16 0016 下午 4:30
 * update: 2017/5/16 0016
 */
...
public class MobileInfoUtils {
    ...
    public static void jumpStartInterface(Context context) {
        ...
        try {
            ...
            if (getMobileType().equals("Xiaomi")) { // 红米Note4,小米3，小米4测试通过
                componentName = new ComponentName("com.miui.securitycenter", "com.miui.permcenter.autostart.AutoStartManagementActivity");
            } else if (getMobileType().equals("Letv")) { // 乐视2测试通过
                intent.setAction("com.letv.android.permissionautoboot");
            } else if (getMobileType().equals("samsung")) { // 三星Note5测试通过
                componentName = new ComponentName("com.samsung.android.sm_cn", "com.samsung.android.sm.++++++++++.ram.AutoRunActivity");
            } else if (getMobileType().equals("HUAWEI")) { // 华为p9测试通过
