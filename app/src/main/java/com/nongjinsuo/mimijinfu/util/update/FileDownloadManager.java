...
public class FileDownloadManager {
    ...
    public long startDownload(String uri, String title, String description) {
        ...
        req.setDestinationInExternalFilesDir(context, Environment.DIRECTORY_DOWNLOADS, context.getResources().getString(R.string.app_name)+".apk");
        //第二种
        //file:///storage/emulated/0/Download/update.apk
//        req.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, title+".apk");
        //第三种 自定义文件路径
