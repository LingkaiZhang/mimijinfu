    ...
    private boolean handleException(final Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                Looper.prepare();
                Toast.makeText(mContext, "程序出错,我们会尽快修复", Toast.LENGTH_SHORT).show();
                Looper.loop();
            }
        }.start();
...
//            KXLog.e(TAG, "Error while collect package info", e);
        }
...
//                KXLog.d(TAG, field.getName() + " : " + field.get(null));
            } catch (Exception e) {
//                KXLog.e(TAG, "Error while collect crash info", e);
            }
        }
    }
...
//                KXLog.e(TAG, "SendReports error.",e);
            }
        }
